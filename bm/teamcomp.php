				...
				<div class="container">
					<div class="page-mainbar resume">
						...
						<div class="resume-header" style="display:inline-block;">
							<!-- Image -->
							<?php $result = file_get_contents('http://www.lolteamcomp.com/php/champions.txt');
							...
							$champ_name1 = $_GET['c1'];
							$id1 = $_GET['id1'];
							$href = "http://www.lolteamcomp.com/bm/champion.php?champ=$champ_name1&id=$id1&region=all";
							?>
						...
						<div class="resume-header" style="display:inline-block;">
							...
							$champ_name2 = $_GET['c2'];
							$id2 = $_GET['id2'];
							$href = "http://www.lolteamcomp.com/bm/champion.php?champ=$champ_name2&id=$id2&region=all";?>
<a href=<?php echo $href; ?> > <img src="<?php echo "http://ddragon.leagueoflegends.com/cdn/5.16.1/img/champion/$key.png";?>" class="img-responsive" alt="" /></a>
							<!-- Heading -->
						...
						<div class="resume-header" style="display:inline-block;">
							...
							$champ_name3 = $_GET['c3'];
							$id3 = $_GET['id3'];
							$href = "http://www.lolteamcomp.com/bm/champion.php?champ=$champ_name3&id=$id3&region=all";?>
							<a href=<?php echo $href; ?> > <img src="<?php echo "http://ddragon.leagueoflegends.com/cdn/5.16.1/img/champion/$key.png";?>" class="img-responsive" alt="" /></a>
							<!-- Heading -->
						...
						<div class="resume-header" style="display:inline-block;">
							...
							$champ_name4 = $_GET['c4'];
							$id4 = $_GET['id4'];
							$href = "http://www.lolteamcomp.com/bm/champion.php?champ=$champ_name4&id=$id4&region=all";?>
							<a href=<?php echo $href; ?> > <img src="<?php echo "http://ddragon.leagueoflegends.com/cdn/5.16.1/img/champion/$key.png";?>" class="img-responsive" alt="" /></a>
							<!-- Heading -->
						...
						<div class="resume-header" style="display:inline-block;">
							...
							$champ_name5 = $_GET['c5'];
							$id5 = $_GET['id5'];
							$href = "http://www.lolteamcomp.com/bm/champion.php?champ=$champ_name5&id=$id5&region=all";?>
							<a href=<?php echo $href; ?> > <img src="<?php echo "http://ddragon.leagueoflegends.com/cdn/5.16.1/img/champion/$key.png";?>" class="img-responsive" alt="" /></a>
							<!-- Heading -->
...
b.loading{
	...
	font-size: 200%;
											...
											if($_GET['region'] == "all"){
												$sql = "SELECT * FROM teams WHERE c1 = $id_array[0] AND c2 = $id_array[1] AND c3 = $id_array[2] AND c4 = $id_array[3] AND c5 = $id_array[4] ORDER BY ((naw + brw + trw+ ruw+ ocew+ euww+ eunew+ krw+ lasw+ lanw)/(naw + brw + trw+ ruw+ ocew+ euww+ eunew+ krw+ lasw+ lanw + nal + brl + trl+ rul+ ocel+ euwl+ eunel+ krl+ lasl+ lanl)) DESC"; //find all of this champs comps
												$result = mysqli_query($conn, $sql);
												$num = mysqli_num_rows($result);
											}else{
												$win_name = $_GET['region'] . "w";
												$loss_name = $_GET['region'] . "l"; //for rows in table
												$sql = "SELECT c1, c2, c3, c4, c5, $win_name, $loss_name FROM teams WHERE c1 = $id_array[0] AND c2 = $id_array[1] AND c3 = $id_array[2] AND c4 = $id_array[3] AND c5 = $id_array[4] AND ($win_name > 0 OR $loss_name > 0) ORDER BY ($win_name/($loss_name + $win_name)) DESC"; //find all of this champs comps
												$result = mysqli_query($conn, $sql);
												$num = mysqli_num_rows($result);
											}
											?>
