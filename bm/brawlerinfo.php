					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="page-mainbar faq">
								<!-- Heading -->
								<h3>Black Market Brawler Info</h3>
								<!-- FAQ Page Content -->
											...
											<div class="panel-heading br-lblue">
												<h4 class="panel-title">
													...
													<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
														<h5><i class="fa fa-angle-right"></i>&nbsp; What are the Brawlers?</h5>
													</a>
												</h4>
											</div>
										...
										<div class="panel panel-default">
											<div class="panel-heading br-green">
												<h4 class="panel-title">
													...
													<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
														<h5><i class="fa fa-angle-right"></i>&nbsp; Four Brawlers Game Info</h5>
													</a>
												</h4>
											</div>
											<div id="collapseTwo" class="panel-collapse collapse">
												...
												<div class="panel-body br-green">
													<img src="img/ironback.jpg" height="300" width="300"/><img src="img/plundercrab.jpg" height="300" width="300"/>
													<img src="img/razorfin.jpg" height="300" width="300"/><img src="img/ocklepod.jpg" height="300" width="300"/>
												</div>
											</div>
										</div>
										<div class="panel panel-default">
											<div class="panel-heading br-purple">
												<h4 class="panel-title">
													...
													<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
														 <h5><i class="fa fa-angle-right"></i>&nbsp; Ability Upgrades</h5>
													</a>
												</h4>
											</div>
											<div id="collapseThree" class="panel-collapse collapse">
												...
												<img src="img/mercenary_1.jpg" height="350" width="350"/><img src="img/mercenary_2.jpg" height="350" width="350"/>
													<img src="img/mercenary_3.jpg" height="350" width="350"/>
													</div>
											</div>
										</div>
										<div class="panel panel-default">
											<div class="panel-heading br-red">
												<h4 class="panel-title">
													...
													<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
														<h5><i class="fa fa-angle-right"></i>&nbsp; Offensive Upgrades</h5>
													</a>
												</h4>
											</div>
											<div id="collapseFour" class="panel-collapse collapse">
												...
												<img src="img/offense_1.jpg" height="100" width="350"/><img src="img/offense_2.jpg" height="100" width="350"/>
													<img src="img/offense_3.jpg" height="100" width="350"/>
												</div>
											</div>
										</div>
										<div class="panel panel-default">
											<div class="panel-heading br-blue">
												<h4 class="panel-title">
													<!-- Faq title -->
													<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
														<h5><i class="fa fa-angle-right"></i>&nbsp; Defensive Upgrades</h5>
													</a>
												</h4>
											</div>
											<div id="collapseFive" class="panel-collapse collapse">
												<!-- faq details -->
												<div class="panel-body br-blue">
												<img src="img/defense_1.jpg" height="100" width="350"/><img src="img/defense_2.jpg" height="100" width="350"/>
													<img src="img/defense_3.jpg" height="100" width="350"/>
												</div>
											</div>
										</div>
