...
<html>
	...
	<script src="http://code.jquery.com/jquery-1.11.0.min.js"></script>
		...
		<div class="wrapper white">
			...
			?>
			<form method="post" action="brawlersearch.php">
			<div class="inner-page">
				<div class="container">
					<div class="page-mainbar resume">
						<!-- Resume Header -->
						<h1 style="text-align: center;">Search for a Brawler</h1>
										...
										<div class="search">
											 ...
											 <table class = "results">
												<tbody class="search" style='text-align:left;'>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Ironback";?>'><img src='img/3612.png' height='30' width='30' />&nbsp Ironback<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Razorfin";?>'><img src='img/3611.png' height='30' width='30' />&nbsp Razorfin<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Ocklepod";?>'><img src='img/3614.png' height='30' width='30' />&nbsp Ocklepod<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Plundercrab";?>'><img src='img/3613.png' height='30' width='30' />&nbsp Plundercrab<br /></a></td></tr>
