			...
			<div class="inner-page">
				<div class="container">
					<div class="page-mainbar resume">
						<!-- Resume Header -->
						<h1 style="text-align: center;">Search for an Item</h1>
						<div class="row" style="text-align:center;">
							<div class="col-md-3 col-sm-4">
								...
								<div class="search">
										...
										<div class="search">
											 <input type="text" id="c1" name='c1' class="form-control" placeholder="Search Items" value="<?php echo $c1; ?>" autocomplete="off">
											 <table class = "results">
												<tbody class="search" style='text-align:left;'>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Typhoon Claws";?>'><img src='img/3652.png' height='30' width='30' />&nbsp Typhoon Claws<br /></a></td></tr>
						
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Lost Chapter";?>'><img src='img/3433.png' height='30' width='30' />&nbsp Lost Chapter<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Pox Arcana";?>'><img src='img/3434.png' height='30' width='30' />&nbsp Pox Arcana<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Netherstride Grimoire";?>'><img src='img/3431.png' height='30' width='30' />&nbsp Netherstride Grimoire<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Rite of Ruin";?>'><img src='img/3430.png' height='30' width='30' />&nbsp Rite of Ruin<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Mirage Blade";?>'><img src='img/3150.png' height='30' width='30' />&nbsp Mirage Blade<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Tricksters Glass";?>'><img src='img/3829.png' height='30' width='30' />&nbsp Trickster's Glass<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Globe of Trust";?>'><img src='img/3840.png' height='30' width='30' />&nbsp Globe of Trust<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Swindlers Orb";?>'><img src='img/3841.png' height='30' width='30' />&nbsp Swindler's Orb<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Murksphere";?>'><img src='img/3844.png' height='30' width='30' />&nbsp Murksphere<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Puppeteer";?>'><img src='img/3745.png' height='30' width='30' />&nbsp Puppeteer<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Staff of Flowing Water";?>'><img src='img/3744.png' height='30' width='30' />&nbsp Staff of Flowing Water<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Dead Mans Plate";?>'><img src='img/3742.png' height='30' width='30' />&nbsp Dead Man's Plate<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Martyrs Gambit";?>'><img src='img/3911.png' height='30' width='30' />&nbsp Martyr's Gambit<br /></a></td></tr>
													<tr><td><a style='text-decoration:none;' href='<?php echo $_SERVER['PHP_SELF'] . "?c1=Flesheater";?>'><img src='img/3924.png' height='30' width='30' />&nbsp Flesheater<br /></a></td></tr>
												</tbody>
											 </table> 
										</div>
						...
						for($i = 3000; $i < 4000; $i++){ //cycle through all champ ids
							$id = 0;
