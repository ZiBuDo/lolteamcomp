...
for($i = 3500; $i < 3700; $i++){ //cycle through all champ ids
	$id = 0;
...
header("Location: http://www.lolteamcomp.com/bm/brawler.php?champ=$correct[1]&id=$cid&region=all"); //redirect to name of correct page
