			...
			<div class="inner-page">
				<div class="container">
					<div class="page-mainbar resume">
						...
						<div class="resume-content" style="text-align:center;">
							<!-- About -->
							<div class="row" style="text-align:center;">
								...
								$pic = $champs->$pic->name;
									$pic = str_replace("'","",$pic); //santize to become same as naming pattern for images which is no spaces and all lower case
									$pic = str_replace(" ","",$pic);
									$pic = strtolower($pic);
									echo "<img src='img/$pic.jpg' height='450' width='300' style='text-align:center;' />";
								?>
								
							<br>
						<table>
						<tr>
							<td><h1>Back to Item Page &nbsp &nbsp </h1></td>
							<td>
								<a href="<?php echo "http://www.lolteamcomp.com/bm/item.php?champ=$_GET[champ]&id=$_GET[id]&region=all"?>" class="btn btn-info">Go </a>&nbsp;
							</td>
						</tr>
						</table>
						</div>
